<%@ Page language="c#" Codebehind="SearchBranch.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.User.SearchBranch" %>
					...
					<TR>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 129px">Branch Code</TD>
									<TD style="WIDTH: 15px"></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox id="TXT_BRANCH_CODE" runat="server" Columns="6"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 129px">Branch Name</TD>
									<TD style="WIDTH: 15px"></TD>
									<TD class="TDBGColorValue">
										<asp:textbox id="TXT_BRANCH_NAME" runat="server" Width="250px"></asp:textbox></TD>
								</TR>
								<TR>
