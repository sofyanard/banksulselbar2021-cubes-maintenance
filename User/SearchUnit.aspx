<%@ Page language="c#" Codebehind="SearchUnit.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.User.SearchUnit" %>
					...
					<TR>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 129px">Unit Code</TD>
									<TD style="WIDTH: 15px"></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox id="TXT_UNIT_CODE" runat="server" Columns="6"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 129px">Unit Name</TD>
									<TD style="WIDTH: 15px"></TD>
									<TD class="TDBGColorValue">
										<asp:textbox id="TXT_UNIT_NAME" runat="server" Width="250px"></asp:textbox></TD>
								</TR>
								<TR>
