...
namespace CuBES_Maintenance.Parameter.ScoringParamAllAppr
{
	/// <summary>
	/// Summary description for ScoringParamAppr.
	/// </summary>
	public partial class ScoringParamAllAppr : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			conn.QueryString = "SELECT PARAMNAME,PARAMLINK FROM RFPARAMETERALL " +
				"WHERE ISMAKER='0' AND PG_ID='4' AND CLASSID='' AND MODULEID='" + Request.QueryString["ModuleID"]+ "' " +
				"ORDER BY PARAMNAME";
			conn.ExecuteQuery();
