...
namespace CuBES_Maintenance.Parameter
{
	...
	/// </summary>
	public partial class CommonParam : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			conn.QueryString = "SELECT PARAMNAME,PARAMLINK FROM RFPARAMETERALL WHERE CLASSID='02' and ISMAKER='1' ORDER BY PARAMNAME";
			conn.ExecuteQuery();
