...
{
	/// <summary>
	/// Summary description for AreaParamAll.
	/// </summary>
	public partial class AreaParamAll : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			conn.QueryString = "SELECT PARAMNAME,PARAMLINK FROM RFPARAMETERALL " +
				"WHERE ISMAKER='1' AND PG_ID='2' AND CLASSID='' AND MODULEID='" + Request.QueryString["ModuleID"]+ "' " +
				"ORDER BY PARAMNAME";
			conn.ExecuteQuery();
