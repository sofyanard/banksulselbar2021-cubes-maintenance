<%@ Page language="c#" Codebehind="LMSProcedurePathAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Area.SME.LMSProcedurePathAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>LMSProcedurePathAppr</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
							...
							<TABLE id="Table2">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center">
										<B>Parameter Maintenance : LMS</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2">
							<asp:datagrid id="DGR_APPR" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True"
								ShowFooter="True">
