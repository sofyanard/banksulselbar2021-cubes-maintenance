<%@ Page language="c#" Codebehind="HouseLocationParamAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Area.Consumer.HouseLocationParamAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>House Location Parameter Approval</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">Parameter House Location Approval</TD>
				</TR>
				<TR>
					<TD colSpan="2"><ASP:DATAGRID id="DG_APPR" runat="server" ShowFooter="True" Width="100%" AllowPaging="True" CellPadding="1"
							...
							<Columns>
								<asp:BoundColumn HeaderText="Code" DataField="ID_LOKASI">
								...
								<asp:BoundColumn HeaderText="City" DataField="CITY_NAME">
									<HeaderStyle CssClass="tdSmallHeader" Width="20%"></HeaderStyle>
								</asp:BoundColumn>
								<asp:BoundColumn HeaderText="Name" DataField="LOKASI">
									<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
								</asp:BoundColumn>
