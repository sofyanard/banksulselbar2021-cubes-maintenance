<%@ Page language="c#" Codebehind="RFAgencyParamAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Area.Consumer.RFAgencyParamAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>TAgency Parameter Approval</title>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">Parameter&nbsp;
						<asp:Label ID="LBL_PARAMNAME" Runat="server"></asp:Label>
						&nbsp;Approval
						<asp:Label id="LBL_TIPE" runat="server" Visible="False"></asp:Label></TD>
				</TR>
				<TR>
