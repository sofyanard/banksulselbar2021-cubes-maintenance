<%@ Page language="c#" Codebehind="ProductBasedOnProgramAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Area.Consumer.ProductBasedOnProgramAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Product Based On Program Approval</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">Parameter Product Base On Program Approval</TD>
				</TR>
				<TR>
						...
						<ASP:DATAGRID id="DG_APPR" runat="server" AutoGenerateColumns="False" CellPadding="1" AllowPaging="True"
							...
							<Columns>
								...
								<asp:BoundColumn HeaderText="Product" DataField="PRODUCTNAME">
									<HeaderStyle CssClass="tdSmallHeader" Width="35%"></HeaderStyle>
								</asp:BoundColumn>
