<%@ Page language="c#" Codebehind="InvestigatorAgencyParam.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Area.Consumer.InvestigatorAgencyParam" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Investigator Agency Parameter</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">Parameter&nbsp;Investigator Agency Maker</TD>
				</TR>
				<TR>
					<TD class="td">
						<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
							...
							<TR>
								...
								<TD style="WIDTH: 10px" align="center">:</TD>
								<TD class="TDBGColorValue"><asp:textbox id="TXT_AGENCY_CODE" runat="server" ReadOnly="True" Columns="10"></asp:textbox></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD style="WIDTH: 10px" align="center">:</TD>
								<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_EMAIL" runat="server" Width="296px" MaxLength="30"></asp:textbox></TD>
							</TR>
							<TR>
