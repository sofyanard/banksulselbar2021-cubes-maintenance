<%@ Page language="c#" Codebehind="MRAgnecyOfficerParamAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Area.Consumer.MRAgnecyOfficerParamAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>MRAgency Officer Parameter Approval</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">Parameter MRAgency Officer Approval
					</TD>
				</TR>
				<TR>
					<TD colSpan="2"><ASP:DATAGRID id="DG_APPR" runat="server" PageSize="5" AutoGenerateColumns="False" CellPadding="1"
							...
							<Columns>
								<asp:BoundColumn Visible="False" DataField="AGENCYID" HeaderText="Code">
