<%@ Page language="c#" Codebehind="HouseLocationParam.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Area.Consumer.HouseLocationParam" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>House Location Parameter</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">Parameter&nbsp;House Location&nbsp;Maker</TD>
				</TR>
				<TR>
					<TD class="td" vAlign="top">
						<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
							...
							<TR>
								...
								<TD style="WIDTH: 7px">:</TD>
								<TD class="TDBGColorValue"><asp:textbox id="TXT_CODE" runat="server" Width="72px" CssClass="mandatory" MaxLength="4"></asp:textbox>
							...
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 250px">Location (Kecamatan, Kabupaten/Kodya)</TD>
								<TD style="WIDTH: 7px">:</TD>
								<TD class="TDBGColorValue"><asp:textbox id="TXT_LOCATION" runat="server" Width="344px" onkeypress="return kutip_satu()"></asp:textbox>
				...
				<TR>
					<TD class="td" colSpan="2"><asp:datagrid id="DGR_EXISTING" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False">
							...
							<Columns>
								<asp:BoundColumn DataField="ID_LOKASI" HeaderText="Code">
								...
								<asp:BoundColumn DataField="LOKASI" HeaderText="Name">
									<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
								</asp:BoundColumn>
