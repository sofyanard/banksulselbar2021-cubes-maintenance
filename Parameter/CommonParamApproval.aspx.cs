...
namespace CuBES_Maintenance.Parameter
{
	...
	/// </summary>
	public partial class CommonParamApproval : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			conn.QueryString = "SELECT PARAMNAME,PARAMLINK FROM RFPARAMETERALL WHERE CLASSID='02' and ISMAKER='0' ORDER BY PARAMNAME";
			conn.ExecuteQuery();
