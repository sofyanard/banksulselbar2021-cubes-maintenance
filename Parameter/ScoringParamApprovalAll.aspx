<%@ Page language="c#" Codebehind="ScoringParamApprovalAll.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.ScoringParamAllAppr.ScoringParamAllAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ScoringParamAppr</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colspan="2">Scoring Parameter - Approval</TD>
					</TR>
					<TR>
