...
{
	/// <summary>
	/// Summary description for CreditCardParam.
	/// </summary>
	public partial class CreditCardParam : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			conn.QueryString = "SELECT PARAMNAME,PARAMLINK,MODULEID FROM RFPARAMETERALL " +
				"WHERE ISMAKER='1' AND PG_ID='3' AND CLASSID='' AND MODULEID='" + Request.QueryString["ModuleID"]+ "' " +
				"ORDER BY PARAMNAME";
			conn.ExecuteQuery();
