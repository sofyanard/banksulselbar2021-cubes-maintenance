<%@ Page language="c#" Codebehind="CUBESSimLimit.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Scoring.Consumer.CUBESSimLimit_aspx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CUBESSimLimit</title>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
									...
									<TABLE id="Table5" style="WIDTH: 408px" cellSpacing="0" cellPadding="0" width="408" border="0">
										<TR>
											<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Template 
													Maintenance&nbsp;: Limit List Simulasi Maker</B></TD>
										</TR>
									</TABLE>
								</TD>
				...
				<TR>
					<TD class="TDBGColor2" colSpan="2"><asp:button id="BTN_SAVE_VAL" CssClass="button1" Text="Save" Runat="server" onclick="BTN_SAVE_VAL_Click"></asp:button>&nbsp;&nbsp;
						<asp:button id="BTN_CANCEL_VAL" CssClass="button1" Text="Cancel" Runat="server" onclick="BTN_CANCEL_VAL_Click"></asp:button>
						<asp:label id="LBL_SAVEMODE_VAL" runat="server" Visible="False">1</asp:label><asp:label id="LBL_DB_NAME" runat="server" Visible="False"></asp:label><asp:label id="LBL_DB_IP" runat="server" Visible="False"></asp:label></TD>
				</TR>
				<TR>
