<%@ Page language="c#" Codebehind="ScoringOtherAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Scoring.Consumer.ScoringOtherAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ScoringOtherAppr</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
									...
									<TABLE id="Table5" style="WIDTH: 408px" cellSpacing="0" cellPadding="0" width="408" border="0">
										<TR>
											<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Parameter Maintenance : 
													Scoring Item Other Approval</B></TD>
										</TR>
									</TABLE>
								</TD>
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">Parameter&nbsp;Scoring&nbsp;Item 
						Other&nbsp;Approval</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD class="TDBGColor2" vAlign="top" align="left" width="50%" colSpan="2">&nbsp;&nbsp;
						<asp:button id="BTN_SUBMIT_LIST" Runat="server" Text="Submit" CssClass="button1" onclick="BTN_SUBMIT_LIST_Click"></asp:button></TD>
				</TR>
			</TABLE>
		</form>
	</body>
