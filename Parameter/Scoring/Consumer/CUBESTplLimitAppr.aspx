<%@ Page language="c#" Codebehind="CUBESTplLimitAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Scoring.Consumer.CUBESTplLimitAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CUBESTplLimitAppr</title>
				...
				<TR>
					<TD class="td">
						<ASP:DATAGRID id="DGR_APPR_TPL" runat="server" ShowFooter="True" AutoGenerateColumns="False" CellPadding="1"
							...
							<Columns>
								<asp:BoundColumn DataField="LMTTPLID" HeaderText="Tempalte ID">
