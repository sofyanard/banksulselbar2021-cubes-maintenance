...
{
	/// <summary>
	/// Summary description for CUBESModel.
	/// </summary>
	public partial class CUBESModel : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!IsPostBack)
			{
				...
				if (LBL_EDITMODE.Text == "1")
				{
					...
					LBL_MAIN_TITLE.Text = "Scoring Maker";
				}
				else if (LBL_EDITMODE.Text == "2")
				{
					LBL_TITLE.Text = "Model Cut Of Score Maker";
					LBL_MAIN_TITLE.Text = "Cut Of Score Maker";
				}
				else
				{
					LBL_TITLE.Text = "Model Limit List Maker";
					LBL_MAIN_TITLE.Text = "Limit List Maker";
				}
			}
			initInputArea();
		...
		protected void BTN_SAVE_VALUE_Click(object sender, System.EventArgs e)
		{
			...
			conn.QueryString = "EXEC PARAM_SCORING_MANDIRI_MODEL_MAKER '"+ LBL_EDITMODE.Text + "', '" + LBL_SAVEMODE.Text +"', '"+ argStr + 
			"', '"+LBL_MODELSEQ.Text+"'"; 
