...
{
	/// <summary>
	/// Summary description for CUBESModelAppr.
	/// </summary>
	public partial class CUBESModelAppr : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!IsPostBack)
			{
				...
				{
					LBL_TITLE.Text = "Model Scoring Approval";
					LBL_MAIN_TITLE.Text = "Scoring Approval";
				}
				else if (LBL_EDITMODE.Text == "2")
				{
					LBL_TITLE.Text = "Model Cut Of Score Approval";
					LBL_MAIN_TITLE.Text = "Cut Of Score Approval";
				}
				else
				{
					LBL_TITLE.Text = "Model Limit List Approval";
					LBL_MAIN_TITLE.Text = "Limit List Approval";
				}
			}
		...
		private void performRequest(int row, string apprflag)
		{
			...
			if (apprflag == "1")
			{
				conn.QueryString = "EXEC PARAM_SCORING_MANDIRI_MODEL_APPR '"+ LBL_EDITMODE.Text + "','"+ argStr + 
