<%@ Page language="c#" Codebehind="CUBESMdlScore.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Scoring.Consumer.CUBESMdlScore" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CUBESMdlScore</title>
				...
				<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="TDBGColor2" colSpan="2"><asp:button id="BTN_SAVE_VALUE" CssClass="button1" Runat="server" Text="Save" Width="70px" onclick="BTN_SAVE_VALUE_Click"></asp:button>&nbsp;
							<asp:button id="BTN_CANCEL_VALUE" CssClass="button1" Runat="server" Text="Cancel" onclick="BTN_CANCEL_VALUE_Click"></asp:button><asp:label id="LBL_SAVEMODE" runat="server" Visible="False">1</asp:label><asp:label id="LBL_EDITMODE" runat="server" Visible="False">1</asp:label></TD>
					</TR>
				</TABLE>
