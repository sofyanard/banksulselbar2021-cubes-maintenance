<%@ Page language="c#" Codebehind="CUBESDimensiItem.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Scoring.Consumer.CUBESDimensiItem" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CUBESDimensiItem</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">Parameter&nbsp;Dimention Maker</TD>
				</TR>
			</TABLE>
			<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%">
					...
					<TD vAlign="top" align="center" colSpan="2">
						<TABLE id="Table7" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								...
								<TD class="TDBGColorValue"><asp:textbox id="TXT_DIMID" runat="server" Width="56px" CssClass="mandatory2" MaxLength="10"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 300px">Dimention&nbsp;Desc</TD>
								<TD style="WIDTH: 7px">:</TD>
								<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_DIMDESC" runat="server" Width="336px" CssClass="mandatory2"
										MaxLength="50"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 300px">Reference Table</TD>
								<TD style="WIDTH: 7px; HEIGHT: 20px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 2px"><asp:textbox onkeypress="return kutip_satu()" id="TXT_REFTABLE" runat="server" Width="336px"
										MaxLength="100"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 300px">Reference Field</TD>
								<TD style="WIDTH: 7px; HEIGHT: 20px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 2px"><asp:textbox onkeypress="return kutip_satu()" id="TXT_REFFIELDID" runat="server" Width="336px"
										MaxLength="100"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 300px">Reference Field Desc</TD>
								<TD style="WIDTH: 7px; HEIGHT: 20px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 2px"><asp:textbox onkeypress="return kutip_satu()" id="TXT_REFFIELDDESC" runat="server" Width="336px"
										MaxLength="100"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 300px">CUBESTable</TD>
								<TD style="WIDTH: 7px; HEIGHT: 20px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 2px"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CBSTABLE" runat="server" Width="336px"
										MaxLength="100"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 300px">CUBES Field</TD>
								<TD style="WIDTH: 7px; HEIGHT: 20px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 2px"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CBSFIELD" runat="server" Width="336px"
										MaxLength="100"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 300px">CUBES&nbsp;Link</TD>
								<TD style="WIDTH: 7px; HEIGHT: 20px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 2px"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CBSLINK" runat="server" Width="336px" MaxLength="100"
										Height="100px" TextMode="MultiLine"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 300px">Prompt Table</TD>
								<TD style="WIDTH: 7px; HEIGHT: 20px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 2px"><asp:textbox onkeypress="return kutip_satu()" id="TXT_PRMTABLE" runat="server" Width="336px"
										MaxLength="100"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 300px">Prompt&nbsp;Field</TD>
								<TD style="WIDTH: 7px; HEIGHT: 20px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 2px"><asp:textbox onkeypress="return kutip_satu()" id="TXT_PRMFIELD" runat="server" Width="336px"
										MaxLength="100"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 300px">Prompt&nbsp;Link</TD>
								<TD style="WIDTH: 7px; HEIGHT: 20px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 2px"><asp:textbox onkeypress="return kutip_satu()" id="TXT_PRMLINK" runat="server" Width="336px" MaxLength="100"
										Height="100px" TextMode="MultiLine"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 300px">Scoring</TD>
								<TD style="WIDTH: 7px; HEIGHT: 20px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 2px"><asp:checkbox id="CHK_SCOFLAG" runat="server"></asp:checkbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 300px">Range</TD>
								<TD style="WIDTH: 7px; HEIGHT: 20px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 2px"><asp:checkbox id="CHK_RNGFLAG" runat="server"></asp:checkbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 300px">Limit</TD>
								<TD style="WIDTH: 7px; HEIGHT: 20px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 2px"><asp:checkbox id="CHK_LMTFLAG" runat="server"></asp:checkbox></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
				...
				<TR>
					<TD vAlign="top" align="center" colSpan="2"><asp:datagrid id="DGR_EXISTING" runat="server" Width="100%" PageSize="5" AutoGenerateColumns="False"
							AllowPaging="True">
							...
							<Columns>
								...
								<asp:BoundColumn DataField="SCOFLAG" Visible="False"></asp:BoundColumn>
								<asp:BoundColumn DataField="RNGFLAG" Visible="False"></asp:BoundColumn>
								<asp:BoundColumn DataField="LMTFLAG" Visible="False"></asp:BoundColumn>
								<asp:TemplateColumn HeaderText="Scoring">
									<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
									<ItemTemplate>
										<asp:CheckBox id="CHK_SCO1" runat="server"></asp:CheckBox>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="Range">
									...
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
									<ItemTemplate>
										<asp:CheckBox id="CHK_RNG1" runat="server"></asp:CheckBox>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="Limit">
									...
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
									<ItemTemplate>
										<asp:CheckBox id="CHK_LMT1" runat="server"></asp:CheckBox>
									</ItemTemplate>
								</asp:TemplateColumn>
