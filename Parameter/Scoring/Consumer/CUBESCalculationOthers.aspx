<%@ Page language="c#" Codebehind="CUBESCalculationOthers.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Scoring.Consumer.CUBESCalculationOthers" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CUBES Calculation Others</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">Parameter&nbsp;CUBES Calculation Other&nbsp;Maker</TD>
				</TR>
				<TR>
					<TD class="TDSmallHeader" colSpan="2">Parameter List Other</TD>
				</TR>
				<TR>
					<TD colSpan="2">
						<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								...
								<TD class="TDBGColorValue"><asp:textbox id="TXT_ID1" onkeypress="return kutip_satu()" runat="server" Width="72px" CssClass="mandatory"
										MaxLength="3"></asp:textbox><asp:label id="LBL_SAVEMODE" runat="server" Visible="False">1</asp:label><asp:label id="LBL_ID" runat="server" Visible="False"></asp:label></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 250px; HEIGHT: 20px">Parameter Name</TD>
								<TD style="WIDTH: 7px; HEIGHT: 20px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 20px"><asp:textbox id="TXT_PARAM_NAME" onkeypress="return kutip_satu()" runat="server" Width="400px"
							...
							<TR>
								...
								<TD class="TDBGColorValue" style="HEIGHT: 20px">
									<asp:textbox id="TXT_PARAM_TABLE_CHILD" onkeypress="return kutip_satu()" runat="server" Width="208px"
										MaxLength="100"></asp:textbox><asp:label id="Label1" runat="server" Visible="False"></asp:label>
									<asp:label id="LBL_PRM" runat="server" Visible="False"></asp:label>
									<asp:label id="Label5" runat="server" Visible="False"></asp:label></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 250px">Parameter PRM</TD>
								<TD style="WIDTH: 7px">:</TD>
								<TD class="TDBGColorValue"><asp:radiobuttonlist id="RBL_PARAM_PRM" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" onselectedindexchanged="RBL_PARAM_PRM_SelectedIndexChanged">
										<asp:ListItem Value="0">CUBES</asp:ListItem>
										<asp:ListItem Value="1">PROMPT</asp:ListItem>
									</asp:radiobuttonlist></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 250px">Parameter Active</TD>
								<TD style="WIDTH: 7px">:</TD>
								<TD class="TDBGColorValue"><asp:radiobuttonlist id="RBL_PARAM_ACTIVE" runat="server" Width="160px" RepeatDirection="Horizontal">
										<asp:ListItem Value="1">Active</asp:ListItem>
										<asp:ListItem Value="0">Non Active</asp:ListItem>
									</asp:radiobuttonlist></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 250px">Parameter Link</TD>
								<TD style="WIDTH: 7px">:</TD>
				...
				<TR>
					<TD class="TDBGColor2" vAlign="top" colSpan="2"><asp:button id="BTN_SAVE_LIST" CssClass="button1" Text="Save" Runat="server" Width="70px" onclick="BTN_SAVE_LIST_Click"></asp:button>&nbsp;&nbsp;
						<asp:button id="BTN_CANCEL_LIST" CssClass="button1" Text="Cancel" Runat="server" onclick="BTN_CANCEL_LIST_Click"></asp:button></TD>
				</TR>
				<TR>
					<TD class="tdSmallHeader" colSpan="2"><P>Current Parameter List Other&nbsp;Data</P>
					</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD class="tdSmallHeader" colSpan="2">Maker Parameter List Other Request</TD>
				</TR>
				<TR>
					<TD class="td" vAlign="top" colSpan="2">
						<asp:datagrid id="DGR_REQUEST_LIST" runat="server" Width="100%" AllowPaging="True" PageSize="5"
				...
				<tr>
				<TR>
					<TD class="tdSmallHeader" colSpan="2">PARAMETER VALUE OTHER</TD>
				</TR>
				<TR>
					<TD vAlign="top" align="center" colSpan="2">
						<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
							...
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 250px; HEIGHT: 20px">Employee Type</TD>
								<TD style="WIDTH: 7px">:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 20px"><asp:dropdownlist id="DDL_EMPLOYEE_TYPE" runat="server" CssClass="mandatory2"></asp:dropdownlist><asp:label id="Label4" runat="server" Visible="False"></asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
				<TR>
					<TD class="TDBGColor2" colSpan="2"><asp:button id="BtnViewValue" CssClass="button1" Text="View Parameter Value" Runat="server" onclick="BtnViewValue_Click"></asp:button></TD>
				</TR>
			</TABLE>
			<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%">
				...
				<TR>
					<TD vAlign="top" align="center" colSpan="2">
						<TABLE id="Table7" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 250px">Parameter Other Value ID</TD>
								<TD style="WIDTH: 7px">:</TD>
								<TD class="TDBGColorValue">
									<asp:textbox id="TXT_ID2" onkeypress="return numbersonly()" runat="server" Width="56px" CssClass="mandatory2"
							...
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 250px">Parameter Other&nbsp;Name</TD>
								<TD style="WIDTH: 7px">:</TD>
								<TD class="TDBGColorValue">
									<asp:textbox id="TXT_PARAM_NAME2" onkeypress="return kutip_satu()" runat="server" Width="336px"
										CssClass="mandatory2" MaxLength="50"></asp:textbox></TD>
							</TR>
						</TABLE>
						<TABLE cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 250px">Parameter Other Value</TD>
								<TD style="WIDTH: 7px">:</TD>
								<TD class="TDBGColorValue">
									<asp:textbox id="TXT_PARAM_VALUE" onkeypress="return digitsonly()" runat="server" Width="136px"
				...
				<TR>
					<TD class="TDBGColor2" colSpan="2"><asp:button id="BTN_SAVE_VALUE" CssClass="button1" Text="Save" Runat="server" Width="70px" onclick="BTN_SAVE_VALUE_Click"></asp:button>&nbsp;
						<asp:button id="BTN_CANCEL_VALUE" CssClass="button1" Text="Cancel" Runat="server" onclick="BTN_CANCEL_VALUE_Click"></asp:button></TD>
				</TR>
				<TR>
					<TD class="tdSmallHeader" colSpan="2">Current Parameter Value&nbsp;Other Data</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD class="tdSmallHeader" align="center" colSpan="2">Maker Parameter Value Other 
						Request&nbsp;</TD>
				</TR>
				<TR>
					<TD colSpan="2"><asp:datagrid id="DGR_REQUEST_VALUE" runat="server" Width="100%" AllowPaging="True" PageSize="5"
							AutoGenerateColumns="False">
							<AlternatingItemStyle CssClass="tblalternating"></AlternatingItemStyle>
							<Columns>
								<asp:BoundColumn DataField="PARAM_OTHER_ID" HeaderText="ID">
