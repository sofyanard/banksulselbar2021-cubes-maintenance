<%@ Page language="c#" Codebehind="ScoringItemAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Scoring.SME.ScoringItemAppr" %>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="TDBGColor2" vAlign="top" align="left" width="50%" colSpan="2">&nbsp;&nbsp;
						<asp:button id="BTN_SUBMIT_LIST" CssClass="button1" Text="Submit" Runat="server" onclick="BTN_SUBMIT_LIST_Click"></asp:button></TD>
				</TR>
			</TABLE>
		</form>
	</body>
