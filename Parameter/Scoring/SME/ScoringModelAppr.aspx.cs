...
{
	/// <summary>
	/// Summary description for ScoringModelAppr.
	/// </summary>
	public partial class ScoringModelAppr : System.Web.UI.Page
	{
		...
		private void performRequestTpl(int row, char appr_sta, string userid)
		{
			...
			string scotplid = DGR_REQUEST.Items[row].Cells[2].Text.Trim();
			
			try 
			{
				conn.QueryString = "EXEC PRMSCORING_SCORINGMODEL_APPR '" + programid + "', '" + scotplid + "', '" + appr_sta + "', '" + userid + "'";
