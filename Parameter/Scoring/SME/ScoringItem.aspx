<%@ Page language="c#" Codebehind="ScoringItem.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Scoring.SME.ScoringItem" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="TDBGColor2" colSpan="2"><asp:button id="BTN_SAVE_LIST" Width="70px" CssClass="button1" Runat="server" Text="Save" onclick="BTN_SAVE_LIST_Click"></asp:button>&nbsp;&nbsp;
