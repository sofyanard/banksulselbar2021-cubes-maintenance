<%@ Page language="c#" Codebehind="ApprovalRange.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Scoring.Small.ApprovalRange" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Approval Range Attribute</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder"><!--<img src="../Image/HeaderDetailDataEntry.jpg">-->
							<TABLE id="Table6">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B> Range Attribute 
											Approval&nbsp;Approval</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2" align="center">
							<asp:Label id="LBL_PARAMNAME" runat="server">APROVAL RANGE ATTRIBUTE</asp:Label></TD>
					</TR>
					...
					<TR>
						<TD class="TDBGColor2" vAlign="top" width="50%" colSpan="2">
							...
							<asp:Label id="_LBNAME_" runat="server" Visible="False">RANGE</asp:Label></TD>
					</TR>
				</TABLE>
			</center>
		</form>
