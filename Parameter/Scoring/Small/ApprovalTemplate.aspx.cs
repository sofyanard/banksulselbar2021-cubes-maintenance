...
{
	/// <summary>
	/// Summary description for ApprovalTemplate.
	/// </summary>
	public partial class ApprovalTemplate : System.Web.UI.Page
	{
		...
		{
			conn.QueryString = "EXEC SCORING_APPROVETEMPLATE '" + id + "','" + approvalFlag + "'";
			conn.ExecuteQuery();
			conn.ClearData();
		}
