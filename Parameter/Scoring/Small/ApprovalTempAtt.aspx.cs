...
{
	/// <summary>
	/// Summary description for ApprovalTempAtt.
	/// </summary>
	public partial class ApprovalTempAtt : System.Web.UI.Page
	{
		...
		{
			conn.QueryString = "EXEC SCORING_APPROVETEMPITEM '" + id + "','" + approvalFlag + "'";
