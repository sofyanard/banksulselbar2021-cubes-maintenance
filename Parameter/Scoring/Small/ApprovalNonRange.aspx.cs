...
{
	/// <summary>
	/// Summary description for ApprovalNonRange.
	/// </summary>
	public partial class ApprovalNonRange : System.Web.UI.Page
	{
		...
		{
			conn.QueryString = "EXEC SCORING_APPROVEWEIGHTNONRANGE '" + id + "','" + approvalFlag + "'";
