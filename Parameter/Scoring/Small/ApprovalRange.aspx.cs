...
{
	/// <summary>
	/// Summary description for ApprovalRange.
	/// </summary>
	public partial class ApprovalRange : System.Web.UI.Page
	{
		...
		{
			conn.QueryString = "EXEC SCORING_APPROVEWEIGHTRANGE '" + id + "','" + approvalFlag + "'";
