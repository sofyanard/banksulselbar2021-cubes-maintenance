<%@ Page language="c#" Codebehind="ApprovalRuleReason.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Scoring.Small.ApprovalRuleReason" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Approval Parameter</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder"><!--<img src="../Image/HeaderDetailDataEntry.jpg">-->
							<TABLE id="Table6">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B> Rule Reason&nbsp;Approval</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2" align="center">
							<asp:Label id="LBL_PARAMNAME" runat="server">APROVAL RULE REASON</asp:Label></TD>
					</TR>
					...
					<TR>
						<TD class="TDBGColor2" vAlign="top" width="50%" colSpan="2">
							...
							<asp:Label id="_LBNAME_" runat="server" Visible="False">RULEREASON</asp:Label></TD>
					</TR>
				</TABLE>
			</center>
		</form>
