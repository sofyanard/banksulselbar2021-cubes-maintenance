<%@ Page language="c#" Codebehind="ApprovalParameter.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.Scoring.Small.ApprovalParameter" %>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder"><!--<img src="../Image/HeaderDetailDataEntry.jpg">-->
							<TABLE id="Table6">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B> Cut Off&nbsp;Approval</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2" align="center">
							<asp:Label id="LBL_PARAMNAME" runat="server">APROVAL CUT OFF</asp:Label></TD>
					</TR>
					...
					<TR>
						<TD class="TDBGColor2" vAlign="top" width="50%" colSpan="2">
							...
							<asp:Label style="Z-INDEX: 0" id="_LBNAME_" runat="server" Visible="False">RULEREASON</asp:Label></TD>
					</TR>
				</TABLE>
			</center>
		</form>
