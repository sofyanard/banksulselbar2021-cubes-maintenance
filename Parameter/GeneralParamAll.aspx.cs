...
namespace CuBES_Maintenance.Parameter
{
	...
	/// </summary>
	public partial class GeneralParamAll : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			conn.QueryString = "SELECT PARAMNAME,PARAMLINK,MODULEID FROM RFPARAMETERALL " +
				"WHERE ISMAKER='1' AND PG_ID='1' AND CLASSID='' AND MODULEID='" + Request.QueryString["ModuleID"]+ "' " +
				"ORDER BY PARAMNAME";
				...
				try
				{
					if ((Request.QueryString["pg"]=="7") || (Request.QueryString["pg"]=="8") )
						conn.QueryString = "SELECT PARAMNAME,PARAMLINK,MODULEID FROM RFPARAMETERALL " +
							...
							"ORDER BY PARAMNAME";
                    //Bank Papua
                    else if ((Request.QueryString["pg"] == "11") || (Request.QueryString["pg"] == "12") || (Request.QueryString["pg"] == "13") || (Request.QueryString["pg"] == "14") || (Request.QueryString["pg"] == "15"))
                        conn.QueryString = "SELECT PARAMNAME,PARAMLINK,MODULEID FROM RFPARAMETERALL " +
                            "WHERE ISMAKER='1' AND PG_ID='" + Request.QueryString["pg"] + "' AND CLASSID='' AND MODULEID='" + Request.QueryString["ModuleID"] + "' " +
                            "ORDER BY PARAMNAME";
				} 
