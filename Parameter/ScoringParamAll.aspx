<%@ Page language="c#" Codebehind="ScoringParamAll.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.ScoringParamAll.ScoringParamAll" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">Scoring&nbsp;Parameter - Maker</TD>
					</TR>
					<TR>
