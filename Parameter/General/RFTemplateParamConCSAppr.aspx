<%@ Page language="c#" Codebehind="RFTemplateParamConCSAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.RFTemplateParamConCSAppr" %>
						...
						<TABLE id="Table6">
							<TR>
								<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>
										<P><B>Parameter Consumer&nbsp;Host&nbsp;Approval</B></P>
									</B>
								</TD>
							</TR>
						</TABLE>
