<%@ Page language="c#" Codebehind="RFTemplateParam2.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.RFTemplateParam2" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RFTemplateParam2</title>
							...
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
										<asp:textbox onkeypress="return kutip_satu()" id="TXT_DESC" runat="server" Width="100%" CssClass="mandatory"
						...
						<TD vAlign="top" width="50%" colSpan="2">
							<ASP:DATAGRID id="DGRequest" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="DESC" HeaderText="Description">
										<HeaderStyle Width="75%" CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
