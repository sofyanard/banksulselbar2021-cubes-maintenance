<%@ Page language="c#" Codebehind="LetterRefParamAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.CC.LetterRefParamAppr" %>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">
						Parameter&nbsp; Letter Reference&nbsp;Approval</TD>
				</TR>
				<TR>
					<TD vAlign="top" align="left" width="50%" colSpan="2">
						<asp:datagrid id="DGR_APPR" runat="server" ShowFooter="True" AutoGenerateColumns="False" AllowPaging="True"
							Width="100%">
							...
							<Columns>
								...
								<asp:BoundColumn DataField="NOFAX" HeaderText="Fax Area">
									<HeaderStyle Width="3%" CssClass="tdSmallHeader"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="NOFAX" HeaderText="Fax Numb">
