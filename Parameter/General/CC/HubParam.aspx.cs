...
{
	/// <summary>
	/// Summary description for HubParam.
	/// </summary>
	public partial class HubParam : System.Web.UI.Page
	{
		...
		{
			this.TXT_HUB_CODE.Text		= "";
			this.TXT_HUB_NAME.Text		= "";
			this.TXT_URUTAN.Text		= "";
			activateControlKey(false);
		}

		private void activateControlKey(bool isReadOnly) 
		{
			this.TXT_HUB_CODE.ReadOnly = isReadOnly;
		}
		...
		{
			conn2.QueryString = "select * from RFHUB where ACTIVE ='1'";
			conn2.ExecuteQuery();
		...
		{
			conn2.QueryString = "select * from PENDING_CC_RFHUB";
			conn2.ExecuteQuery();
			DataTable dt = new DataTable();
			dt = conn2.GetDataTable().Copy();
			...
			{
				this.DGR_REQUEST.Items[i].Cells[4].Text = getPendingStatus(DGR_REQUEST.Items[i].Cells[4].Text) ;
			}			
		}
		...
		protected void BTN_SAVE_Click(object sender, System.EventArgs e)
		{
			...
			{
				conn2.QueryString = "select * from RFHUB where ACTIVE ='1' AND HUB_CODE ='"+ this.TXT_HUB_CODE.Text +"'";
				conn2.ExecuteQuery();
			...
			conn2.QueryString = "exec PARAM_GENERAL_CC_RFHUB_MAKER  '"+this.LBL_SAVEMODE.Text +"','" +
				this.TXT_HUB_CODE.Text + "','" + this.TXT_HUB_NAME.Text + "','" +
				this.TXT_URUTAN.Text.Trim() +"'";
			conn2.ExecuteQuery();
		...
		private void DGR_EXISTING_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			switch(((LinkButton)e.CommandSource).CommandName.ToLower())
			{
				case "edit":
					LBL_SAVEMODE.Text = "0";
					this.TXT_HUB_CODE.Text = CleansText(e.Item.Cells[0].Text);
					this.TXT_HUB_NAME.Text = CleansText(e.Item.Cells[1].Text);
					this.TXT_URUTAN.Text = CleansText(e.Item.Cells[2].Text);
					activateControlKey(true);
					break;

				case "delete":					
					conn2.QueryString = "exec PARAM_GENERAL_CC_RFHUB_MAKER '2','" +
		...
		private void DGR_REQUEST_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			switch(((LinkButton)e.CommandSource).CommandName.ToLower())
			{
				...
				case "delete":
					...
					conn2.QueryString = "delete from PENDING_CC_RFHUB WHERE HUB_CODE='" + id + "'";
					conn2.ExecuteQuery();
					ViewPendingData();
					break;
				default :
