...
{
	/// <summary>
	/// Summary description for GradeParamAppr.
	/// </summary>
	public partial class GradeParamAppr : System.Web.UI.Page
	{
		...
		private void performRequestList(int row, char appr_sta)
		{
			...
			string category_id	= this.DGR_APPR.Items[row].Cells[0].Text.Trim();
			string gol_id		= this.DGR_APPR.Items[row].Cells[2].Text.Trim();
			conn2.QueryString = " exec PARAM_CC_RFJOB_TYPE_GOLONGAN_APPR '" + appr_sta + "','" + 
				category_id + "','" + gol_id + "','" + userid + "','" + paramname + "','" + paramclass+ "'";
