...
{
	/// <summary>
	/// Summary description for StaffParam.
	/// </summary>
	public partial class StaffParam : System.Web.UI.Page
	{
		...
		{
			this.TXT_NIP_ID.ReadOnly = isReadOnly;
		}
		...
		{
			conn2.QueryString = "select * from RFSGM where ACTIVE ='1'";
			conn2.ExecuteQuery();
		...
		private void ViewPendingData()
		{
			...
			{
				this.DGR_REQUEST.Items[i].Cells[2].Text = getPendingStatus(DGR_REQUEST.Items[i].Cells[2].Text) ;
			}			
		}
		...
		protected void BTN_SAVE_Click(object sender, System.EventArgs e)
		{
			...
			{
				conn2.QueryString = "select NIP_ID from RFSGM where ACTIVE ='1' and NIP_ID ='"+ this.TXT_NIP_ID.Text +"'";
				conn2.ExecuteQuery();
			...
			conn2.QueryString = "exec PARAM_GENERAL_CC_RFSGM_MAKER '"+this.LBL_SAVEMODE.Text +"','" +
				this.TXT_NIP_ID.Text + "','" + this.TXT_NAMA.Text +"'";
			conn2.ExecuteQuery();
		...
		private void DGR_EXISTING_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			switch(((LinkButton)e.CommandSource).CommandName.ToLower())
			{
				case "edit":
					LBL_SAVEMODE.Text = "0";
					this.TXT_NIP_ID.Text = CleansText(e.Item.Cells[0].Text.Trim());
					this.TXT_NAMA.Text = CleansText(e.Item.Cells[1].Text.Trim());
					activateControlKey(true);
					break;

				case "delete":					
					conn2.QueryString = "exec PARAM_GENERAL_CC_RFSGM_MAKER  '2','" +
		...
		private void DGR_REQUEST_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			switch(((LinkButton)e.CommandSource).CommandName.ToLower())
			{
				...
				case "delete":
					...
					conn2.QueryString = "delete from PENDING_CC_RFSGM WHERE NIP_ID='" + id + "'";
					conn2.ExecuteQuery();
					ViewPendingData();
					break;
				default :
