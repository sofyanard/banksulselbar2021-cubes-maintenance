...
{
	/// <summary>
	/// Summary description for TypeEmploymentParamAppr.
	/// </summary>
	public partial class TypeEmploymentParamAppr : System.Web.UI.Page
	{
		...
		private void PerformRequest(int row)
		{
			try 
            {
				...
				conn2.QueryString = "exec PARAM_CC_JOB_TYPE_APPR '" + id + "','"+ 
