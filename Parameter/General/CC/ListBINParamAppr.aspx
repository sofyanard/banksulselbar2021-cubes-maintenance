<%@ Page language="c#" Codebehind="ListBINParamAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.CC.ListBINParamAppr" %>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">
						Parameter&nbsp; List BIN Issuer Approval</TD>
				</TR>
				<TR>
