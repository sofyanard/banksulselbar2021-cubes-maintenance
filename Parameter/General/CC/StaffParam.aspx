<%@ Page language="c#" Codebehind="StaffParam.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.CC.StaffParam" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>StaffParam</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">
							Parameter&nbsp;Staff Maker</TD>
					</TR>
					<TR>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" width="202" style="WIDTH: 202px">NIP</TD>
									<TD style="WIDTH: 7px"></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox id="TXT_NIP_ID" onkeypress="return kutip_satu()" runat="server" Width="184px" CssClass="mandatory"
								...
								<TR>
									...
									<TD style="WIDTH: 7px"></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox id="TXT_NAMA" onkeypress="return kutip_satu()" runat="server" Width="472px" MaxLength="80"></asp:TextBox></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
