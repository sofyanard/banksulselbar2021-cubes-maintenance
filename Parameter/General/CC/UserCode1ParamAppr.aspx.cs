...
{
	/// <summary>
	/// Summary description for UserCode1ParamAppr.
	/// </summary>
	public partial class UserCode1ParamAppr : System.Web.UI.Page
	{
		...
		private void ViewPendingData()
		{
			...
			{
				this.DGR_APPR.Items[i].Cells[11].Text = getPendingStatus(this.DGR_APPR.Items[i].Cells[11].Text);
			}			
		}
		...
		private void performRequestList(int row, char appr_sta)
		{
			...
			conn2.QueryString = " exec PARAM_CC_RFUSERCODE1_APPR '" + appr_sta + "','" + id + "','" +
