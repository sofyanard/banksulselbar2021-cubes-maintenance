...
{
	/// <summary>
	/// Summary description for CawParamAppr.
	/// </summary>
	public partial class CawParamAppr : System.Web.UI.Page
	{
		...
		private void ViewPendingData()
		{
			...
			{
				this.DGR_APPR.Items[i].Cells[9].Text = getPendingStatus(DGR_APPR.Items[i].Cells[9].Text) ;
				this.DGR_APPR.Items[i].Cells[6].Text = GlobalTools.MoneyFormat(DGR_APPR.Items[i].Cells[6].Text) ;
				this.DGR_APPR.Items[i].Cells[7].Text = GlobalTools.MoneyFormat(DGR_APPR.Items[i].Cells[7].Text) ;
			}			
		}
		...
		private void performRequestList(int row, char appr_sta)
		{
			...
			string cw_code		= CleansText(this.DGR_APPR.Items[row].Cells[0].Text);
			string cw_type		= CleansText(this.DGR_APPR.Items[row].Cells[1].Text);
			string job_type_id	= CleansText(this.DGR_APPR.Items[row].Cells[2].Text);
			string productid	= CleansText(this.DGR_APPR.Items[row].Cells[3].Text);
			...
			conn2.QueryString = " exec PARAM_CC_RFCAWCAL_APPR '" + 
				appr_sta + "','" + cw_code + "','" + cw_type + "','" + job_type_id + "','" + productid + "','" +
