...
{
	/// <summary>
	/// Summary description for HubParamAppr.
	/// </summary>
	public partial class HubParamAppr : System.Web.UI.Page
	{
		...
		private void ViewPendingData()
		{
			...
			{
				this.DGR_APPR.Items[i].Cells[4].Text = getPendingStatus(DGR_APPR.Items[i].Cells[4].Text) ;
			}			
		}
		...
		private void PerformRequest(int row)
		{
			try 
			{
				...
				hub_code = DGR_APPR.Items[row].Cells[0].Text.Trim();
				conn2.QueryString = "exec PARAM_CC_RFHUB_APPR '" + hub_code + "','"+ 
