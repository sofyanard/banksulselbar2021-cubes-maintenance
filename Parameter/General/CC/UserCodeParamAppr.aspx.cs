...
{
	/// <summary>
	/// Summary description for UserCodeParamAppr.
	/// </summary>
	public partial class UserCodeParamAppr : System.Web.UI.Page
	{
		...
		private void performRequestList(int row, char appr_sta)
		{
			...
			string sc_code= this.DGR_APPR.Items[row].Cells[0].Text.Trim();
			conn2.QueryString = " exec PARAM_CC_SCGROUP_APPR '" + 
				appr_sta + "',  '" + sc_code + "','" + 
