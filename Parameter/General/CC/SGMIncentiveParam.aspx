<%@ Page language="c#" Codebehind="SGMIncentiveParam.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.CC.SGMIncentiveParam" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SGMIncentiveParam</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">
							Parameter SGM Incentive Maker</TD>
					</TR>
					<TR>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" width="202" style="WIDTH: 202px">Min Approval</TD>
									<TD style="WIDTH: 7px"></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox onkeypress="return numbersonly()" id="TXT_MIN_APPR" runat="server" Width="184px"></asp:TextBox></TD>
								</TR>
								<TR>
									...
									<TD style="WIDTH: 7px"></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox onkeypress="return numbersonly()" id="TXT_MAX_APPR" runat="server" Width="184px"></asp:TextBox></TD>
								</TR>
								<TR>
									...
									<TD style="WIDTH: 7px"></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox onkeypress="return numbersonly()" id="TXT_INCENTIVE" runat="server" Width="184px"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 202px">Remark</TD>
									<TD style="WIDTH: 7px"></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox id="TXT_REMARK" onkeypress="return kutip_satu()" runat="server" Width="184px"></asp:TextBox>
										<asp:Label id="LBL_MIN" runat="server" Visible="False"></asp:Label>
