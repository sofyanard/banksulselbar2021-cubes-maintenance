<%@ Page language="c#" Codebehind="RFTemplateParamCC.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.RFTemplateParamCC" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RFTemplateParamCC</title>
							...
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 23px">
										<asp:textbox id="TXT_ID" onkeypress="return kutip_satu()" runat="server" CssClass="mandatory"
											MaxLength="50"></asp:textbox><asp:label id="LBL_SAVEMODE" runat="server" Visible="False">1</asp:label><asp:label id="LBL_ACTIVE" runat="server" Visible="False"></asp:label><asp:label id="LBL_ID" runat="server" Visible="False"></asp:label><asp:label id="LBL_DESC" runat="server" Visible="False"></asp:label>&nbsp;
										<asp:Label id="LBL_LIBUR" runat="server">(DD/MM/YYYY)</asp:Label></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 20px" vAlign="top">Description</TD>
									<TD style="HEIGHT: 20px" vAlign="top">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px"><asp:textbox id="TXT_DESC" onkeypress="return kutip_satu()" runat="server" CssClass="mandatory"
