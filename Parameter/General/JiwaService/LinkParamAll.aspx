<%@ Page language="c#" Codebehind="LinkParamAll.aspx.cs" AutoEventWireup="false" Inherits="CuBES_Maintenance.Parameter.General.JiwaService.LinkParamAll" %>
					...
					<tr id="TR_GROUP" runat="server">
						<td class="td" vAlign="top" width="60%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; BORDER-BOTTOM: gray 1px solid">Customer 
										Unit :
									</TD>
									<TD class="TDBGColorValue" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; WIDTH: 43px; BORDER-BOTTOM: gray 1px solid">
										<asp:dropdownlist id="DDL_BCHTYPEID" runat="server" CssClass="Mandatory" Width=300px></asp:dropdownlist></TD>
								</TR>
								<TR>
									...
									<TD class="TDBGColorValue" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; WIDTH: 43px; BORDER-BOTTOM: gray 1px solid">
										<asp:dropdownlist id="DDL_GRPTYPEID" runat="server" AutoPostBack="True" CssClass="Mandatory" Width=300px></asp:dropdownlist></TD>
								</TR>
								<TR>
									...
									<TD class="TDBGColorValue" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; WIDTH: 43px; BORDER-BOTTOM: gray 1px solid">
										<asp:dropdownlist id="DDL_DEPTTYPEID" runat="server" Width=300px></asp:dropdownlist></TD>
								</TR>
								<TR>
