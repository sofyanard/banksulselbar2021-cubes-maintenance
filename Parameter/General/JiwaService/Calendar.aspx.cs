...
namespace CuBES_Maintenance.Parameter.General.JiwaService
{
	...
	{
		protected System.Web.UI.WebControls.DataGrid DGR_CALENDAR;
		protected System.Web.UI.WebControls.TextBox LST_RESULT;
		...
		{    
			...
			this.SAVE.ServerClick += new System.EventHandler(this.SAVE_ServerClick);
			this.CLEAR.ServerClick += new System.EventHandler(this.CLEAR_ServerClick);
			this.CLOSE.ServerClick += new System.EventHandler(this.CLOSE_ServerClick);
		...
		private void CLOSE_ServerClick(object sender, System.EventArgs e)
		{
			Close();
