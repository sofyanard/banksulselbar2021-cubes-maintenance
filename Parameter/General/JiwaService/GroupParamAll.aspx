<%@ Page language="c#" Codebehind="GroupParamAll.aspx.cs" AutoEventWireup="false" Inherits="CuBES_Maintenance.Parameter.General.JiwaService.GroupParamAll" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>GroupParamAll</title>
				...
				<table width="100%" border="0">
					<tr>
						<td align="left">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>GROUP PROVIDER</B></TD>
								</TR>
							</TABLE>
						</td>
							...
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; WIDTH: 43px; BORDER-BOTTOM: gray 1px solid">
										<asp:textbox id="TXT_GRPCODE" runat="server" BorderStyle="None" ReadOnly="True" Width="352px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; BORDER-BOTTOM: gray 1px solid">GROUP 
										NAME :
									...
									<TD class="TDBGColorValue" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; WIDTH: 43px; BORDER-BOTTOM: gray 1px solid">
										<asp:textbox id="TXT_GRPNAME" runat="server" BorderStyle="None" Width="352px" CssClass="mandatory"></asp:textbox></TD>
									<TD><asp:label id="LBL_GROUPID" runat="server" Visible="False"></asp:label></TD>
								</TR>
							</TABLE>
						</td>
					</tr>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2">
							<asp:datagrid id="DGR_GROUP" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="DESC_CUR" HeaderText="Description">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2">
							<asp:datagrid id="DGR_REQUESTGROUP" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True">
								<AlternatingItemStyle CssClass="TblAlternating"></AlternatingItemStyle>
								<Columns>
									<asp:BoundColumn DataField="CODE" HeaderText="Code">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
