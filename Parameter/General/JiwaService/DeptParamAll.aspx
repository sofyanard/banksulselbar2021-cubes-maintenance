<%@ Page language="c#" Codebehind="DeptParamAll.aspx.cs" AutoEventWireup="false" Inherits="CuBES_Maintenance.Parameter.General.JiwaService.DeptParamAll" %>
					...
					<tr id="TR_GROUP" runat="server">
						<td class="td" vAlign="top" width="60%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; BORDER-BOTTOM: gray 1px solid; HEIGHT: 8px">GROUP 
										NAME :
									</TD>
									<TD class="TDBGColorValue" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; WIDTH: 43px; BORDER-BOTTOM: gray 1px solid; HEIGHT: 8px">
								...
								<TR>
									...
									<TD class="TDBGColorValue" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; WIDTH: 43px; BORDER-BOTTOM: gray 1px solid">
										<asp:textbox id="TXT_DEPTNAME" runat="server" BorderStyle="None" Width="352px" CssClass="mandatory"></asp:textbox></TD>
								</TR>
								<TR>
