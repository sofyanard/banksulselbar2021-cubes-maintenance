...
namespace CuBES_Maintenance.Parameter.General.SME
{
	...
	/// </summary>
	public partial class RFCertTypeParam2 : System.Web.UI.Page
	{
		...
		{
			conn.QueryString = "select CERTTYPEID,CERTTYPEDESC,RATINGCODE from RFCERTTYPE WHERE ACTIVE=1";
			conn.ExecuteQuery();
		...
		private void DataGrid2_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			switch(((LinkButton)e.CommandSource).CommandName)
			{
				...
				case "delete":
					LBL_SAVEMODE.Text = "2";
					conn.QueryString = "DELETE PENDING_RFCERTTYPE2 WHERE CERTTYPEID='"+e.Item.Cells[0].Text.Trim()+"' ";
...
//			{  
			...
			conn.QueryString = "select CERTTYPEID from RFCERTTYPE where CERTTYPEID ='"+TXT_A.Text.Trim()+"' "+
								" AND CERTTYPEDESC = '"+TXT_B.Text.TrimEnd().TrimStart()+"' and RATINGCODE = '"+TXT_C.Text.Trim()+"' ";				
			conn.ExecuteQuery();
			...
			{
				conn.QueryString = "INSERT INTO PENDING_RFCERTTYPE2(CERTTYPEID,CERTTYPEDESC,RATINGCODE,PENDINGSTATUS,ACTIVE) VALUES ('"+TXT_A.Text+"', '"+TXT_B.Text+"','"+TXT_C.Text+"','"+LBL_SAVEMODE.Text+"','1')";
				conn.ExecuteQuery();
				bindData2();
				clearEditBoxes();
				LBL_SAVEMODE.Text = "1";
