<%@ Page language="c#" Codebehind="RFBankAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.RFBankAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RFBankAppr</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD vAlign="top" width="50%" colSpan="2"><asp:datagrid id="DG_PENDING" runat="server" ShowFooter="True" AutoGenerateColumns="False" CellPadding="1"
