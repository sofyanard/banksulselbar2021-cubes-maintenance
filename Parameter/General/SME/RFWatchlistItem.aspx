<%@ Page language="c#" Codebehind="RFWatchlistItem.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.RFWatchlistItem" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RFWatchlistItem</title>
						...
						<TD class="td" vAlign="top" width="50%" colSpan="2">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_BUSSUNIT" Runat="server" AutoPostBack="True" CssClass="mandatory" onselectedindexchanged="DDL_BUSSUNIT_SelectedIndexChanged"></asp:dropdownlist></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" width="20%">Watchlist Code</TD>
									<TD style="WIDTH: 15px">:</TD>
								...
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 20px" vAlign="top">Watchlist Desc</TD>
									<TD style="WIDTH: 15px">:</TD>
