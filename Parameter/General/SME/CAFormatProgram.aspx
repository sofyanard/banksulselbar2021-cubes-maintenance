<%@ Page language="c#" Codebehind="CAFormatProgram.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.CAFormatProgram" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CAFormatProgram</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">
							Parameter&nbsp;Analysis Format&nbsp;Maker</TD>
					</TR>
					<TR>
						<TD class="td" vAlign="top" width="50%" colspan="2">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 12px">
										Format</TD>
									<TD style="WIDTH: 15px; HEIGHT: 12px"></TD>
									<TD class="TDBGColorValue" style="HEIGHT: 12px">
										<asp:DropDownList id="DDL_FORMAT" runat="server" Width="240px" CssClass="mandatory2"></asp:DropDownList></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Program</TD>
									<TD style="WIDTH: 15px"></TD>
									<TD class="TDBGColorValue">
										<asp:DropDownList id="DDL_AP" runat="server" Width="240px" CssClass="mandatory2"></asp:DropDownList>&nbsp;
										<asp:Button id="BTN_VIEW" runat="server" Width="53px" Text="View" onclick="BTN_VIEW_Click"></asp:Button>&nbsp;&nbsp; 
					...
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="left" width="50%" colSpan="2" style="HEIGHT: 34px"><asp:button id="BTN_SAVE" Runat="server" Text="Save" CssClass="button1" onclick="BTN_SAVE_Click"></asp:button>&nbsp;&nbsp;
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">
							<P>Current&nbsp;&nbsp;Analysis Format&nbsp; Table</P>
						</TD>
					</TR>
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="Datagrid1" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="5"
								...
								<Columns>
									<asp:BoundColumn Visible="False" DataField="FORMATID" HeaderText="Format ID">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="FORMATDESC" HeaderText="Format Desc">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn Visible="False" DataField="PROGRAMID" HeaderText="Program ID">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="PROGRAMDESC" HeaderText="Program Desc">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
