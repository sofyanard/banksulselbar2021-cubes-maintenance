<%@ Page language="c#" Codebehind="RFLiquidationRate.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.RFLiquidationRate" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RFLiquidationRate</title>
					...
					<TR id="TR_PERSONAL" runat="server">
						<TD class="td" vAlign="top" width="50%" colspan="2">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" width="129" style="HEIGHT: 21px">Rating Code</TD>
									<TD style="WIDTH: 15px; HEIGHT: 21px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 21px">
										<asp:textbox onkeypress="return kutip_satu()" id="TXT_ID" runat="server" MaxLength="50" CssClass="mandatory" ontextchanged="TXT_ID_TextChanged"></asp:textbox>
								...
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 20px" vAlign="top">Liquidation Value</TD>
									<TD style="HEIGHT: 20px" vAlign="top">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
										<asp:textbox onkeypress="return numbersonly()" id="TXT_DESC" runat="server" MaxLength="500" Width="136px"
					...
					<TR>
						<TD vAlign="top" width="50%" colSpan="2">
							<ASP:DATAGRID id="DGExisting" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1"
								...
								<Columns>
									<asp:BoundColumn DataField="ID" HeaderText="Rating Code">
										<HeaderStyle Width="100px" CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="DESC" HeaderText="Liquidation Value">
