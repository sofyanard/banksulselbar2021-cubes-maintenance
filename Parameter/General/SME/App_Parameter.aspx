<%@ Page language="c#" Codebehind="App_Parameter.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.App_Parameter" %>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">
							Parameter&nbsp;Scoring/Rating Counter&nbsp;Maker</TD>
					</TR>
					<TR>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 227px; HEIGHT: 20px" width="227">Max Pre 
										Scoring Count</TD>
									<TD style="WIDTH: 6px; HEIGHT: 20px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
										<asp:TextBox onkeypress="return numbersonly()" id="TXT_PS" runat="server" Width="64px" MaxLength="50"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 227px">
										Max Final Scoring Count</TD>
									<TD style="WIDTH: 6px; HEIGHT: 22px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 22px">
										<asp:TextBox onkeypress="return numbersonly()" id="TXT_FS" runat="server" Width="64px" MaxLength="1"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 227px; HEIGHT: 22px">Max Acquire Information 
										Count</TD>
									<TD style="WIDTH: 6px; HEIGHT: 22px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 22px">
										<asp:TextBox onkeypress="return numbersonly()" id="TXT_ACQ" runat="server" Width="64px" MaxLength="2"></asp:TextBox>&nbsp;</TD>
								</TR>
							</TABLE>
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">
							<P>Current Scoring/Rating Counter Table</P>
						</TD>
					</TR>
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2">
							<asp:datagrid id="DGR_EXISTING" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="5"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="APP_ROOT" HeaderText="APP ROOT">
									...
									<asp:BoundColumn DataField="MAX_FS_COUNT" HeaderText="Max. Final Scoring Count">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
						...
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2">
							<asp:datagrid id="DGR_REQUEST" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="5"
								...
								<Columns>
									...
									<asp:BoundColumn Visible="False" DataField="APP_ROOT" HeaderText="APP ROOT">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="MAX_PS_COUNT" HeaderText="Max. Pre Scoring Count">
