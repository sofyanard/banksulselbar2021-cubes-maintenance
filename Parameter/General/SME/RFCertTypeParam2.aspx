<%@ Page language="c#" Codebehind="RFCertTypeParam2.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.RFCertTypeParam2" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RFCertTypeParam2</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">Parameter&nbsp;Document Type&nbsp;Maker</TD>
					</TR>
					<TR>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_A" runat="server" CssClass="mandatory"
											Width="48px" MaxLength="50"></asp:textbox><asp:label id="Label1" runat="server" Visible="False">Label</asp:label></TD>
								</TR>
								<TR>
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">
							<P>Current&nbsp;&nbsp;Document Type&nbsp; Table</P>
						</TD>
					</TR>
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="Datagrid1" runat="server" Width="100%" PageSize="5" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="C" HeaderText="Rating Code">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DataGrid2" runat="server" Width="100%" PageSize="5" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="D" HeaderText="Status">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:TemplateColumn HeaderText="Function">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
