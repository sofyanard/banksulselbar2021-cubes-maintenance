<%@ Page language="c#" Codebehind="RFCHANN_PARAM_LIST_Appr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.RFCHANN_PARAM_LIST_Appr" %>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2" align="center">
							Current RF Channeling Parameter Table</TD>
					</TR>
					...
					<TR>
						<TD vAlign="top" width="50%" colSpan="2">
							<ASP:DATAGRID id="DGRequest" runat="server" Width="100%" AllowPaging="True" CellPadding="1" AutoGenerateColumns="False"
								...
								<Columns>
									<asp:BoundColumn DataField="CD_PRM_CODE" HeaderText="Param Code">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="CH_PRM_NAME" HeaderText="Param Name">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="CH_PRM_REJECTDESC" HeaderText="Reject Desc.">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									...
									<asp:TemplateColumn HeaderText="Approve">
										<HeaderStyle HorizontalAlign="Center" Width="6%" CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
										<ItemTemplate>
