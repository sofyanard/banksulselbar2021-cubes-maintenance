...
namespace CuBES_Maintenance.Parameter.General.SME
{
	...
	/// </summary>
	public partial class RFCA_ASPEKPRGAppr : System.Web.UI.Page
	{
		...
		private void performRequest(int row, string _status)
		{
			try 
			{
				...
				conn.QueryString = "exec PARAM_GENERAL_RFCA_ASPEKPRG_APPR '" + _progid + "', '" + _aspekid + "', '" + _status + "', '" + Session["UserID"].ToString() + "'";
