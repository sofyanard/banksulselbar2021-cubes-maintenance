<%@ Page language="c#" Codebehind="RF_FAIRISAAC_PROGRAMAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.RF_FAIRISAAC_PROGRAMAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RF_FAIRISAAC_PROGRAMAppr</title>
					...
					<TR>
						<TD vAlign="top" align="left" width="50%" colSpan="2"><asp:datagrid id="DTG_APPR" runat="server" ShowFooter="True" AutoGenerateColumns="False" PageSize="5"
								...
								<Columns>
									...
									<asp:BoundColumn Visible="False" DataField="fairisaacid" HeaderText="FAIRISSACID"></asp:BoundColumn>
									<asp:BoundColumn DataField="fairissacdesc" HeaderText="Fair Isaac">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>									
