<%@ Page language="c#" Codebehind="RFCA_ASPEKPRG.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.RFCA_ASPEKPRG" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Aspek - Program (Maker)</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">Parameter&nbsp;Aspek-Aspek Maker</TD>
					</TR>
					<TR>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD class="TDBGColorValue">
										<asp:dropdownlist id="DDL_CA_ASPEK" runat="server" CssClass="mandatory2" Width="300px"></asp:dropdownlist></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DGR_CURRENT" runat="server" Width="100%" PageSize="18" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:BoundColumn Visible="False" DataField="ASPEKID" HeaderText="ASPEKID">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="ASPEKDESC" HeaderText="Aspek">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
