<%@ Page language="c#" Codebehind="RFScoredCardLinkAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.RFSCORECARDLINKAPR" %>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD vAlign="top" align="left" width="50%" colSpan="2"><asp:datagrid id="DTG_APPR" runat="server" Width="100%" AllowPaging="True" PageSize="5" AutoGenerateColumns="False"
								...
								<Columns>
									<asp:BoundColumn Visible="False" DataField="loanpurpid" HeaderText="loanpurpid"></asp:BoundColumn>
