<%@ Page language="c#" Codebehind="SCREENSUBMENUAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.SCREENSUBMENUAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SCREEN SUB MENU Approval</title>
					...
					<TR>
						<TD vAlign="top" align="left" width="50%" colSpan="2"><asp:datagrid id="DTG_APPR" runat="server" ShowFooter="True" AutoGenerateColumns="False" PageSize="5"
								...
								<Columns>
									...
									<asp:BoundColumn Visible="False" DataField="MENUCODE" HeaderText="BUSSUNITID"></asp:BoundColumn>
