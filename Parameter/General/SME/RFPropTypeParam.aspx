<%@ Page language="c#" Codebehind="RFPropTypeParam.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.RFPropTypeParam" %>
							...
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
										<asp:textbox onkeypress="return kutip_satu()" id="TXT_DESC" runat="server" MaxLength="30" Width="700px"
								...
								<TR>
									...
									<TD style="HEIGHT: 20px" vAlign="top">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
										<asp:TextBox onkeypress="return kutip_satu()" id="TXT_PROPTYPELINK" runat="server" MaxLength="100"
