<%@ Page language="c#" Codebehind="RFCreditScheme_ProgramAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.RFCreditScheme_ProgramAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RFCreditScheme_ProgramAppr</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">Parameter&nbsp;Approval For&nbsp;RFCreditScheme 
							Program Table</TD>
					</TR>
					<TR>
						<TD vAlign="top" align="left" width="50%" colSpan="2"><asp:datagrid id="DTG_APPR" runat="server" ShowFooter="True" AutoGenerateColumns="False" PageSize="5"
								...
								<Columns>
									...
									<asp:BoundColumn Visible="False" DataField="CREDITSCHEMEID" HeaderText="CREDITSCHEME"></asp:BoundColumn>
									...
									<asp:BoundColumn DataField="CREDITSCHEME" HeaderText="CREDITSCHEME DESC">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
