...
namespace CuBES_Maintenance.Parameter.General.SME
{
	...
	public partial class RFCityParam : System.Web.UI.Page
	{
		...
		private void viewPendingData(string AREAID) 
		{
			...
			/// data di tabel pending ditampilin semua
//			conn.QueryString = "select * from VW_PARAM_GENERAL_PENDING_RFCITY where AREAID = '"+ AREAID +"'";

			conn.QueryString = "select * from VW_PARAM_GENERAL_PENDING_RFCITY ";
			conn.ExecuteQuery();
...
//			else
		...
		protected void BTN_SAVE_Click(object sender, System.EventArgs e)
		{
			...
			{
				conn.QueryString = "select active from RFCITY WHERE CITYID ='" + TXT_ID.Text.Trim() + "'";
				conn.ExecuteQuery();
