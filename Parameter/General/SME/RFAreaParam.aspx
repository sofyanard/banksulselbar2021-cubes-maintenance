<%@ Page language="c#" Codebehind="RFAreaParam.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.RFAreaParam" %>
						...
						<TD class="td" vAlign="top" width="50%" colSpan="2">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_ID" onkeypress="return kutip_satu()" runat="server" CssClass="mandatory"
