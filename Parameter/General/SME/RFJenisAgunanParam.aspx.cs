...
namespace CuBES_Maintenance.Parameter.General.SME
{
	...
	public partial class RFAgunanParam : System.Web.UI.Page
	{
		...
		protected void BTN_SAVE_Click(object sender, System.EventArgs e)
		{
		    ...
		    if (DDL_COLTYPEID.SelectedValue == "&nbsp;")
		    {
		        DDL_COLTYPEID.SelectedValue = "";
		    }


		    executeMaker(TXT_ID.Text.Trim(), TXT_DESC.Text.Trim(), DDL_COLTYPEID.SelectedValue.Trim(), LBL_SAVEMODE.Text.Trim());
			viewPendingData();
			clearControls();
		...
		{			
			...
			switch(((LinkButton)e.CommandSource).CommandName.ToLower())
			{
				case "edit":
                    ...
                    DDL_COLTYPEID.SelectedValue = e.Item.Cells[2].Text == "&nbsp;" ? "" : e.Item.Cells[2].Text;
