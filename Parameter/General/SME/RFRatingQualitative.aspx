<%@ Page language="c#" Codebehind="RFRatingQualitative.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.RFRatingQualitative" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RFRatingQualitative</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR id="TR_PERSONAL" runat="server">
						<TD class="td" vAlign="top" width="50%" colSpan="2">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" width="20%">Qualitative ID</TD>
								...
								<TR>
									<TD class="TDBGColor1" width="20%"><asp:checkbox id="CHK_HAVEPARENT" runat="server" AutoPostBack="True" Text="Have Parent" oncheckedchanged="CHK_HAVEPARENT_CheckedChanged"></asp:checkbox></TD>
									<TD style="WIDTH: 15px">:</TD>
									<TD class="TDBGColorValue">
										Parent&nbsp;<asp:dropdownlist id="DDL_PARENT" runat="server" AutoPostBack="True" Enabled="False"></asp:dropdownlist>
									</TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" width="20%"><asp:checkbox id="CHK_HAVECHILD" runat="server" AutoPostBack="True" Text="Have Child"></asp:checkbox></TD>
									<TD style="WIDTH: 15px">:</TD>
								...
								<TR>
									...
									<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_QUALTPL_ID" runat="server" CssClass="mandatory"></asp:dropdownlist></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
					...
					<TR>
						<TD vAlign="top" width="50%" colSpan="2"><ASP:DATAGRID id="DGExisting" runat="server" Width="100%" AllowPaging="True" CellPadding="1" AutoGenerateColumns="False">
								...
								<Columns>
									<asp:BoundColumn DataField="QUALITATIVEID" HeaderText="Qualitative ID">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="QUALITATIVEDESC" HeaderText="Description">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="HAVEPARENT" Visible="False">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="HAVEPARENTDESC" HeaderText="Have Parent">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="PARENT" Visible="False">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="PARENTDESC" HeaderText="Parent">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="HAVECHILD" Visible="False">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="HAVECHILDDESC" HeaderText="Have Child">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="QUALTPL_ID" Visible="False">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="QUALTPL_DESC" HeaderText="Template">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
