<%@ Page language="c#" Codebehind="TATCommitmentModel.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.SME.TATCommitmentModel" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>TATCommitmentModel</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				...
				<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%">
					<TR>
						<TD class="tdHeader1" colSpan="2"><asp:label id="LBL_TITLE" runat="server">Model TAT Commitment Maker</asp:label></TD>
					</TR>
					<TR>
