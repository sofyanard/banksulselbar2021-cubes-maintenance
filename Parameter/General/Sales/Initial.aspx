<%@ Page language="c#" Codebehind="Initial.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Sales.Initial" %>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">
							Parameter&nbsp;Initial Maker</TD>
					</TR>
					<TR>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 227px; HEIGHT: 20px" width="227">Photo 
										Directory</TD>
									<TD style="WIDTH: 6px; HEIGHT: 20px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
										<asp:TextBox id="TXT_PHOTO_DIR" runat="server" Width="208px" CssClass="mandatory" MaxLength="50"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 227px">Max Number of Children for Tax</TD>
									<TD style="WIDTH: 6px; HEIGHT: 22px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 22px">
										<asp:TextBox onkeypress="return numbersonly()" id="TXT_MAX_CHILD_TAX" runat="server" Width="48px"
											MaxLength="1"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 227px; HEIGHT: 22px">PPH Psl. 21</TD>
									<TD style="WIDTH: 6px; HEIGHT: 22px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 22px">
										<asp:TextBox onkeypress="return numbersonly()" id="TXT_PPH" runat="server" Width="48px" MaxLength="2"></asp:TextBox>&nbsp;%</TD>
								</TR>
							</TABLE>
							<asp:Label id="LBL_IN_SEQ" runat="server" Visible="False"></asp:Label>
						...
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2">
							<asp:datagrid id="DGR_EXISTING" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="5"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="IN_MAXTANGGUNGAN" HeaderText="Max. Number of Choldren for Tax">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
