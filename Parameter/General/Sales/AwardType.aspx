<%@ Page language="c#" Codebehind="AwardType.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Sales.AwardType" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">Parameter&nbsp;Award Type Maker</TD>
					</TR>
					<TR>
										...
										<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
											<TR>
												...
												<TD class="TDBGColorValue" style="HEIGHT: 20px">
													<asp:TextBox id="TXT_CODE" runat="server" CssClass="mandatory" MaxLength="10"></asp:TextBox></TD>
											</TR>
											<TR>
												...
												<TD class="TDBGColorValue" style="HEIGHT: 22px">
													<asp:TextBox id="TXT_DESC" runat="server" Width="368px" CssClass="mandatory" MaxLength="50"></asp:TextBox>&nbsp;</TD>
											</TR>
										</TABLE>
									</TD>
									<TD width="50%">
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DGR_EXISTING" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="5"
								...
								<Columns>
									<asp:BoundColumn DataField="AWARD_ID" HeaderText="Code">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center" Width="15%"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="AWARD_DESC" HeaderText="Description">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
