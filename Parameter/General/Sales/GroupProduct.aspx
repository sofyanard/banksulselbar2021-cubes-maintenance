<%@ Page language="c#" Codebehind="GroupProduct.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Sales.GroupProduct" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">Parameter&nbsp;Group Product Maker</TD>
					</TR>
					<TR>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 172px; HEIGHT: 17px" width="172">
										Code</TD>
									<TD style="WIDTH: 7px; HEIGHT: 17px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 17px">
										<asp:TextBox id="TXT_ID" runat="server" CssClass="mandatory" Enabled="False" MaxLength="10"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 172px">
										Description</TD>
									<TD style="WIDTH: 7px; HEIGHT: 22px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 22px"><asp:textbox id="TXT_DESC" runat="server" Width="100%" CssClass="mandatory" MaxLength="30"></asp:textbox></TD>
								</TR>
							</TABLE>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DGR_EXISTING" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="5"
								...
								<Columns>
									<asp:BoundColumn Visible="False" HeaderText="Group_id"></asp:BoundColumn>
									<asp:BoundColumn HeaderText="No">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="GROUP_ID" HeaderText="Code">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="GROUP_NAME" HeaderText="Description">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
