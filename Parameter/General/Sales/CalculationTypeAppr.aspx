<%@ Page language="c#" Codebehind="CalculationTypeAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Sales.CalculationTypeAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CalculationTypeAppr</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">
							Parameter Calculation Type&nbsp;Approval</TD>
					</TR>
					<TR>
						<TD vAlign="top" align="left" width="50%" colSpan="2">
							<asp:datagrid id="DGR_APPR" runat="server" AutoGenerateColumns="False" PageSize="5" AllowPaging="True"
								...
								<Columns>
									...
									<asp:BoundColumn Visible="False" DataField="CAL_INCENTIVE" HeaderText="Incentive">
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
