<%@ Page language="c#" Codebehind="Allowance.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Sales.Allowance" %>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">
							Parameter&nbsp;Allowance Maker</TD>
					</TR>
					<TR>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 227px; HEIGHT: 20px" width="227">Agent Type</TD>
									<TD style="WIDTH: 6px; HEIGHT: 20px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
										<asp:DropDownList id="DDL_AGENT_TYPE" runat="server" CssClass="mandatory"></asp:DropDownList></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD style="WIDTH: 6px; HEIGHT: 22px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 22px">
										<asp:TextBox onkeypress="return numbersonly()" id="TXT_ALLOWANCE" runat="server" Width="144px"
											MaxLength="11"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 227px; HEIGHT: 22px">Allowance Target Point</TD>
									<TD style="WIDTH: 6px; HEIGHT: 22px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 22px">
										<asp:TextBox onkeypress="return numbersonly()" id="TXT_ALLOWANCE_TARGET" runat="server" Width="88px"
								...
								<TR>
									...
									<TD style="WIDTH: 6px; HEIGHT: 22px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 22px">
										<asp:TextBox onkeypress="return numbersonly()" id="TXT_PHONE_ALLOWANCE" runat="server" Width="144px"
											MaxLength="10"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 227px; HEIGHT: 22px">Disburse Target Point</TD>
									<TD style="WIDTH: 6px; HEIGHT: 22px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 22px">
										<asp:TextBox onkeypress="return numbersonly()" id="TXT_DISBURSE_TARGET" runat="server" Width="88px"
											MaxLength="11"></asp:TextBox></TD>
								</TR>
							</TABLE>
						...
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2">
							<asp:datagrid id="DGR_EXISTING" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="5"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="TARGET_POINT" HeaderText="Allowance Target Point">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="PHONE_ALLOWANCE" HeaderText="Phone Allowance">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="TARGET_COMMISIPOINT" HeaderText="Disburse Point Target">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									...
									<asp:BoundColumn Visible="False" DataField="AGENT_TYPE" HeaderText="AGENT_TYPE">
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
