<%@ Page language="c#" Codebehind="FormulaSetupParamAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Sales.FormulaSetupParamAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>FormulaSetupParamAppr</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" style="HEIGHT: 26px" colSpan="2">Parameter&nbsp;Formula 
							Setup&nbsp;Approval</TD>
					</TR>
					<TR>
