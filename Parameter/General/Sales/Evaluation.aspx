<%@ Page language="c#" Codebehind="Evaluation.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Sales.Evaluation" %>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">
							Parameter&nbsp;Evaluation Maker</TD>
					</TR>
					<TR>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 172px; HEIGHT: 17px" width="172">Evaluation ID</TD>
								...
								<TR>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 22px"><asp:textbox id="TXT_EVAL_DESC" runat="server" Width="100%" CssClass="mandatory" MaxLength="50"></asp:textbox></TD>
								</TR>
							</TABLE>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DGR_EXISTING" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="5"
								...
								<Columns>
									<asp:BoundColumn Visible="False" HeaderText="Evaluation_id"></asp:BoundColumn>
