<%@ Page language="c#" Codebehind="CriteriaTypeAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Sales.CriteriaTypeAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CriteriaTypeAppr</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" style="HEIGHT: 26px" colSpan="2">Parameter&nbsp;Criteria 
							Type&nbsp;Approval</TD>
					</TR>
					<TR>
						<TD vAlign="top" align="left" width="50%" colSpan="2"><asp:datagrid id="DGR_APPR" runat="server" ShowFooter="True" Width="100%" AllowPaging="True" PageSize="5"
								...
								<Columns>
									<asp:BoundColumn Visible="False" DataField="CRITERIA_ID" HeaderText="Criteria ID"></asp:BoundColumn>
									<asp:BoundColumn DataField="CRITERIA_DESC" HeaderText="Criteria Description">
