<%@ Page language="c#" Codebehind="EvaluationAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Sales.EvaluationAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>EvaluationAppr</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2" style="HEIGHT: 26px">
							Parameter&nbsp;Evaluation Approval</TD>
					</TR>
					<TR>
