<%@ Page language="c#" Codebehind="CommByProdAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Sales.CommByProdAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CommByProdAppr</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">
							Parameter&nbsp;Commission by Product Approval</TD>
					</TR>
					<TR>
						<TD vAlign="top" align="left" width="50%" colSpan="2">
							<asp:datagrid id="DGR_APPR" runat="server" AutoGenerateColumns="False" PageSize="5" AllowPaging="True"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="COMMISION_VALUE" HeaderText="Commision Point">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									...
									<asp:BoundColumn Visible="False" DataField="PRODUCT_ID" HeaderText="PRODUCT_ID"></asp:BoundColumn>
