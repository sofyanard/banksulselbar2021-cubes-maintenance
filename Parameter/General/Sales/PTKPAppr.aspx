<%@ Page language="c#" Codebehind="PTKPAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Sales.PTKPAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PTKPAppr</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">Parameter&nbsp;PTKP Approval</TD>
					</TR>
					<TR>
						<TD vAlign="top" align="left" width="50%" colSpan="2">
							<asp:datagrid id="DGR_APPR" runat="server" Width="100%" AllowPaging="True" PageSize="5" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:BoundColumn Visible="False" DataField="Agen_Marital" HeaderText="Agen Marital"></asp:BoundColumn>
									<asp:BoundColumn Visible="False" DataField="Spouse_Status" HeaderText="Spouse Status"></asp:BoundColumn>
