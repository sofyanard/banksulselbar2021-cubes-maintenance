...
{
	/// <summary>
	/// Summary description for AreaParam.
	/// </summary>
	public partial class AreaParam : System.Web.UI.Page
	{
		...
		{
			conn.QueryString = "select AREA_ID,AREA_NAME,CD_SIBS,AR_ADDR1,AR_ADDR2,AR_ADDR3,AR_CITY,AR_ZIPCODE, AR_SRCCODE from AREA where active='1'";
			conn.ExecuteQuery();
		...
		private void bindData2()
		{
			...
			conn.QueryString = "select AREA_ID,AREA_NAME,AR_ADDR1,AR_ADDR2,AR_ADDR3,AR_CITY,AR_ZIPCODE, AR_SRCCODE,CH_STA from TAREA";
			conn.ExecuteQuery();
		...
		private void Datagrid1_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			switch(((LinkButton)e.CommandSource).CommandName)
			{
				case "edit":
					...
					TXT_AREA1.Text= e.Item.Cells[1].Text.Trim();
					TXT_ADDR.Text= e.Item.Cells[2].Text.Trim();
					TXT_CITY.Text= e.Item.Cells[3].Text.Trim();
					TXT_ZIPCODE.Text= e.Item.Cells[4].Text.Trim();
					TXT_AREACODE.Text= e.Item.Cells[5].Text.Trim();
					
					LBL_SAVEMODE.Text = "0";
					cleansTextBox(TXT_CODE);
					cleansTextBox(TXT_AREA1);
					cleansTextBox(TXT_CITY);
					cleansTextBox(TXT_ZIPCODE);
					cleansTextBox(TXT_AREACODE);
					cleansTextBox(TXT_ADDR);
				...
				case "delete":
					...
					conn.QueryString = "EXEC PARAM_GENERAL_AREA '1','" +
						e.Item.Cells[0].Text.Trim()+ "', '" + e.Item.Cells[1].Text.Trim() + "', null, '" + 
						e.Item.Cells[2].Text.Trim() + "','','', '"+e.Item.Cells[3].Text.Trim()+"', '"+e.Item.Cells[4].Text.Trim()+"', '"+e.Item.Cells[5].Text.Trim()+"', '2' ,'','' " ;
					conn.ExecuteQuery();
		...
		private void DataGrid2_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			switch(((LinkButton)e.CommandSource).CommandName)
			{
				...
				TXT_CITY.Text= e.Item.Cells[3].Text.Trim();
				TXT_ZIPCODE.Text= e.Item.Cells[4].Text.Trim();
				TXT_AREACODE.Text= e.Item.Cells[6].Text.Trim();
				LBL_SAVEMODE.Text = "0";
				...
				case "delete":
					string area_id = e.Item.Cells[0].Text.Trim();
					conn.QueryString = "EXEC PARAM_GENERAL_AREA '2','"+area_id+"','','','','','','','','','' , '',''";
		...
		protected void BTN_SAVE_Click(object sender, System.EventArgs e)
		{
			...
			{
				conn.QueryString = "select * from AREA where AREA_ID='"+TXT_CODE.Text+ "'";
				conn.ExecuteQuery();
			...
			conn.QueryString = "EXEC PARAM_GENERAL_AREA '1','" +
				TXT_CODE.Text+ "', '" + TXT_AREA1.Text+ "', null, '" + 
				TXT_ADDR.Text+ "','','', '"+TXT_CITY.Text+"', '"+TXT_ZIPCODE.Text+"', '"+TXT_AREACODE.Text+"', '"+LBL_SAVEMODE.Text+"' ,'','' " ;
			conn.ExecuteNonQuery();
			bindData2();
			clearEditBoxes();
			LBL_SAVEMODE.Text = "1";
