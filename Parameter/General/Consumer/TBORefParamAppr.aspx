<%@ Page language="c#" Codebehind="TBORefParamAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Consumer.TBORefParamAppr" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">Parameter TBO Referensi Approval</TD>
				</TR>
				<TR>
					<TD vAlign="top" colSpan="2"><ASP:DATAGRID id="DG_APPR" runat="server" ShowFooter="True" Width="100%" AllowPaging="True" CellPadding="1"
							...
							<Columns>
								...
								<asp:BoundColumn HeaderText="Expiry Duration" DataField="EXPDURATION">
									<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
								</asp:BoundColumn>
