<%@ Page language="c#" Codebehind="AssuranceCompParamAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Consumer.AssuranceCompParamAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>AssuranceCompParamAppr</title>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2" align="center">
						Parameter Assurance Company Approval</TD>
				</TR>
