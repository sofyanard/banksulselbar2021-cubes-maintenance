<%@ Page language="c#" Codebehind="GpmCoefficientAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Consumer.GpmCoefficientAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>GpmCoefficientAppr</title>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2" align="center">
						Parameter GPM Coefficient Approval</TD>
				</TR>
					...
					<TD vAlign="top" width="50%" colSpan="2">
						<ASP:DATAGRID id="DGR_APPR" runat="server" Width="100%" AllowPaging="True" CellPadding="1" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="tn_seq" HeaderText="TN Seq">
									<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
