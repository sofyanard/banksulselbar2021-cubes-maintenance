<%@ Page language="c#" Codebehind="CompanyParamAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Consumer.CompanyParamAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Company Parameter Approval</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">Parameter Company Legal Type Approval</TD>
				</TR>
				<TR>
					<TD class="BackGroundList" style="HEIGHT: 27px" colSpan="2"><strong>Module :</strong>
						<asp:dropdownlist id="DDL_MODULE" AutoPostBack="True" Runat="server" onselectedindexchanged="DDL_MODULE_SelectedIndexChanged"></asp:dropdownlist><asp:label id="LBL_ID" runat="server" Visible="False"></asp:label><asp:label id="LBL_DESC" runat="server" Visible="False"></asp:label><asp:label id="LBL_SBC" runat="server" Visible="False"></asp:label><asp:label id="LBL_TABNAME" runat="server" Visible="False"></asp:label>
				...
				<TR>
					<TD class="TDBGColor2" colSpan="2"><asp:button id="BTN_SUBMIT" Runat="server" CssClass="button1" Text="Submit" onclick="BTN_SUBMIT_Click"></asp:button><asp:label id="LBL_DB_IP" runat="server" Visible="False"></asp:label><asp:label id="LBL_DB_NAME" runat="server" Visible="False"></asp:label></TD>
				</TR>
			</TABLE>
		</form>
	</body>
