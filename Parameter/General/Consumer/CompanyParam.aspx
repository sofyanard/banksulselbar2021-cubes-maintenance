<%@ Page language="c#" Codebehind="CompanyParam.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Consumer.CompanyParam" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Company Parameter</title>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">
						Parameter&nbsp;Company&nbsp;Type Maker</TD>
				</TR>
				<TR>
					<TD class="td">
						<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								...
								<TD class="TDBGColorValue">
									<asp:radiobuttonlist id="RDB_MODULE" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
							...
							<TR>
								...
								<TD style="WIDTH: 10px" align="center">:</TD>
								<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CP_CODE" runat="server" MaxLength="3" Columns="5"
							...
							<TR>
								...
								<TD align="center">:</TD>
								<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CP_DESC" runat="server" MaxLength="60"
										Columns="60" CssClass="mandatory"></asp:textbox></TD>
							</TR>
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">
						<P>Current&nbsp;Company Legal Type&nbsp;Table</P>
					</TD>
				</TR>
				<TR>
