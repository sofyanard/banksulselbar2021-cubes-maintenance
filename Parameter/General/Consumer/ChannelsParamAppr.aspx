<%@ Page language="c#" Codebehind="ChannelsParamAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Consumer.ChannelsParamAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Channels Parameter Approval</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">Parameter Channels Approval</TD>
				</TR>
				<TR>
					<TD class="BackGroundList" style="HEIGHT: 27px" colSpan="2"><strong>Module :</strong>
						<asp:dropdownlist id="DDL_MODULE" Runat="server" AutoPostBack="True" onselectedindexchanged="DDL_MODULE_SelectedIndexChanged"></asp:dropdownlist>
						<asp:Label id="LBL_ID" runat="server" Visible="False"></asp:Label>
						<asp:Label id="LBL_DESC" runat="server" Visible="False"></asp:Label>
						<asp:Label id="LBL_SBC" runat="server" Visible="False"></asp:Label>
						<asp:Label id="LBL_TABNAME" runat="server" Visible="False"></asp:Label>
						<asp:Label id="LBL_SRC" runat="server" Visible="False"></asp:Label>
