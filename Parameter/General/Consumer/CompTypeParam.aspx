<%@ Page language="c#" Codebehind="CompTypeParam.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Consumer.CompTypeParam" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Company Type Parameter</title>
						...
						<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								...
								<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_ID" runat="server" CssClass="mandatory"
										MaxLength="4" Columns="10"></asp:textbox><asp:label id="LBL_SAVEMODE" runat="server" Visible="False"></asp:label>
							...
							<TR>
								...
								<TD class="TDBGColorValue" style="HEIGHT: 20px"><asp:textbox onkeypress="return kutip_satu()" id="TXT_DESC" runat="server" CssClass="mandatory"
										MaxLength="30" Columns="50"></asp:textbox></TD>
							</TR>
							<TR>
				...
				<TR>
					<TD vAlign="top" colSpan="2">
						<ASP:DATAGRID id="DGEXISTING" runat="server" Width="100%" AllowPaging="True" CellPadding="1" AutoGenerateColumns="False">
							...
							<Columns>
								<asp:BoundColumn DataField="CT_CODE" HeaderText="Code">
									<HeaderStyle Width="100px" CssClass="tdSmallHeader"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="CT_DESC" HeaderText="Description">
