<%@ Page language="c#" Codebehind="InsLifeJoinParam.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Consumer.InsLifeJoinParam" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>InsLifeJoinParam</title>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">
						Parameter Insurance Life Join Maker</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">
						<P>
							Current&nbsp;Insurance Life Join Table</P>
					</TD>
				</TR>
				<TR>
