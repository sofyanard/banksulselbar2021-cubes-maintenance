...
{
	/// <summary>
	/// Summary description for InsLifeSingleParamAppr.
	/// </summary>
	public partial class InsLifeSingleParamAppr : System.Web.UI.Page
	{
		...
		private void performRequest(int row)
		{
			try 
			{
				...
				conn.QueryString="select * from TMANDIRI_LIFE_SINGLERATE where SEQ_ID='"+
				...
				if (status.Equals("0"))
				{
					conn.QueryString = "EXEC PARAM_GENERAL_MANDIRI_LIFE_SINGLERATE '3','"+SEQ_ID+"','" +
				...
				if (status.Equals("1"))
				{
					conn.QueryString = "EXEC PARAM_GENERAL_MANDIRI_LIFE_SINGLERATE '4','"+SEQ_ID+"','" +
						SEQ_NO+ "','" +RATE_AGE+ "','" + RATE_MASA +"','"+RATE_VALUE+"','"+
						TIPE+"','"+status+"','"+userid+"','"+groupid+"'" ;
					conn.ExecuteNonQuery();
				}
				if (status.Equals("2"))
				{
					conn.QueryString = "EXEC PARAM_GENERAL_MANDIRI_LIFE_SINGLERATE '5','"+SEQ_ID+"','" +
						SEQ_NO+ "','" +RATE_AGE+ "','" + RATE_MASA +"','"+RATE_VALUE+"','"+
						TIPE+"','"+status+"','"+userid+"','"+groupid+"'" ;
					conn.ExecuteNonQuery();
				}

				conn.QueryString = "EXEC PARAM_GENERAL_MANDIRI_LIFE_SINGLERATE '2','"+SEQ_ID+"','" +
					SEQ_NO+ "','','','','','','',''" ;
				conn.ExecuteNonQuery();
