...
{
	/// <summary>
	/// Summary description for DTBOItemsParam.
	/// </summary>
	public partial class DTBOItemsParam : System.Web.UI.Page
	{
		...
		private void ViewData()
		{
			...
			DDL_UPLOAD.Items.Clear();
			DDL_UPLOAD.Items.Add(new ListItem("Yes", "1"));
			DDL_UPLOAD.Items.Add(new ListItem("No", "0"));
			DDL_PRINT.Items.Clear();
			DDL_PRINT.Items.Add(new ListItem("Yes", "1"));
			DDL_PRINT.Items.Add(new ListItem("No", "0"));
			LBL_SAVEMODE.Text = "1";
		...
		{
			conn.QueryString = "SELECT CW_CODE,CW_DESC,SIBS_FLAG,CW_PRINT,CD_SIBS,(case when SIBS_FLAG=1 then 'Yes' else 'No' End) FLAG,(case when CW_PRINT=1 then 'Yes' else 'No' End) PRINTT FROM RFCAWLST where active='1'";
			conn.ExecuteQuery();
		...
		private void clearEditBoxes()
		{
			...
			try
			{
				DDL_UPLOAD.SelectedIndex = 0;
				DDL_PRINT.SelectedIndex = 0;
			} 
			catch {}
		...
		private void Datagrid1_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			switch(((LinkButton)e.CommandSource).CommandName)
			{
				case "edit":		
					...
					TXT_SBC.Text = e.Item.Cells[6].Text;

					try
					{
						DDL_UPLOAD.SelectedValue=e.Item.Cells[0].Text.Trim();
						DDL_PRINT.SelectedValue = e.Item.Cells[1].Text.Trim();
					} 
					catch {}
				...
				case "delete":
					...
					conn.QueryString = "EXEC PARAM_GENERAL_DTBOITEM '1','" +
						e.Item.Cells[2].Text.Trim()+"', "+GlobalTools.ConvertNull(e.Item.Cells[3].Text.Trim())+", '" + 
						e.Item.Cells[0].Text.Trim()+"', '"+e.Item.Cells[1].Text.Trim()+"', '2', "+GlobalTools.ConvertNull(e.Item.Cells[6].Text.Trim())+"  ,'',''";
		...
		private void DataGrid2_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			switch(((LinkButton)e.CommandSource).CommandName)
			{
				...
				case "delete":
					LBL_SAVEMODE.Text = "2";
					conn.QueryString = "EXEC PARAM_GENERAL_DTBOITEM '2','" +
						e.Item.Cells[2].Text.Trim()+ "', '"+e.Item.Cells[3].Text.Trim()+"', '" + 
		...
		protected void BTN_SAVE_Click(object sender, System.EventArgs e)
		{
			...
			{
				conn.QueryString = "select * from RFCAWLST WHERE CW_CODE='" +TXT_CODE.Text+ "'";
				conn.ExecuteQuery();
			...
			conn.QueryString = "EXEC PARAM_GENERAL_DTBOITEM '1','" +
				...
				DDL_UPLOAD.SelectedValue+"', '"+DDL_PRINT.SelectedValue+"', '"+
				LBL_SAVEMODE.Text+"', "+GlobalTools.ConvertNull(TXT_SBC.Text)+"  ,'',''";
			conn.ExecuteNonQuery();
		...
		protected void DDL_UPLOAD_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			if(DDL_UPLOAD.SelectedValue == "1")
