<%@ Page language="c#" Codebehind="InsFireParamAppr.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.Consumer.InsFireParamAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>InsFireParamAppr</title>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<TR>
					<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2" align="center">
						Parameter Insurance Fire Approval</TD>
				</TR>
					...
					<TD vAlign="top" width="50%" colSpan="2">
						<ASP:DATAGRID id="DGR_APPR" runat="server" Width="100%" AllowPaging="True" CellPadding="1" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundColumn Visible="False" DataField="CH_STA" HeaderText="STATUSnya"></asp:BoundColumn>
							</Columns>
